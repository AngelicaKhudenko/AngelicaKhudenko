...
public class CalculatorWithMemoryDecoratorTest {
    ICalculator calculator = new CalculatorWithMemoryDecorator(new CalculatorWithCounterAutoSuper());
    ...
    public void saveAndLoad() {
        ...
        double result=((CalculatorWithMemoryDecorator) calculator).load();
        Assertions.assertEquals(25632,result);
    }
}
